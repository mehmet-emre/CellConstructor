...
public class ReactionTryOnTest {
    ...
    public static Collection<Object[]> data() {
        ...
        parameters.add(new Object[]{
                new Reaction(A, 1, false, B, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(B, 2), true, 2, 3, true});
        parameters.add(new Object[]{
                new Reaction(A, 1, false, A, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(B, 2), false, 1, 2, false});
        parameters.add(new Object[]{
                new Reaction(B, 1, false, B, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(B, 2), false, 1, 2, false});
        parameters.add(new Object[]{
                new Reaction(A, 1, false, B, 1, 2, true, 3, 1), createAtom(A, 1),
                createAtom(B, 2), false, 1, 2, false});
        parameters.add(new Object[]{
                new Reaction(A, 2, false, B, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(B, 2), false, 1, 2, false});
        parameters.add(new Object[]{new Reaction(A, 1, true, B, 2, 2, true, 3, 1),
                createAtom(A, 1), createAtom(B, 2), false, 1, 2, false});
        parameters.add(new Object[]{
                new Reaction(X, 1, false, X, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(A, 2), true, 2, 3, true});
        parameters.add(new Object[]{
                new Reaction(X, 1, false, X, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(B, 2), false, 1, 2, false});
        parameters.add(new Object[]{
                new Reaction(Y, 1, false, Y, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(A, 2), true, 2, 3, true});
        parameters.add(new Object[]{
                new Reaction(Y, 1, false, Y, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(B, 2), false, 1, 2, false});
        parameters.add(new Object[]{
                new Reaction(X, 1, false, Y, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(A, 2), true, 2, 3, true});
        parameters.add(new Object[]{
                new Reaction(X, 1, false, Y, 2, 2, true, 3, 1), createAtom(A, 1),
                createAtom(B, 2), true, 2, 3, true});
